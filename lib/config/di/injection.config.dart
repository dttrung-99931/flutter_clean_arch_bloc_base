...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i364.CacheMaxStaleModifierInterceptor>(
    ...
    gh.lazySingleton<_i872.Storage>(() => appModuleDepedenciesProvider.provideStorage(gh<_i872.LocalStorage>()));
    gh.factory<_i64.HomeBloc>(() => _i64.HomeBloc(gh<_i872.Storage>()));
    gh.lazySingleton<_i707.AuthInterceptor>(() => _i707.AuthInterceptor(gh<_i872.Storage>()));
    gh.lazySingleton<_i93.LogoutUseCase>(() => _i93.LogoutUseCase(gh<_i872.Storage>()));
    gh.lazySingleton<_i869.CheckLoginUseCase>(() => _i869.CheckLoginUseCase(gh<_i872.Storage>()));
    ...
    gh.lazySingleton<_i840.AuthDatasource>(() => authRepoteDatasourceProvider.provideAuthDatasource(gh<_i361.Dio>()));
    gh.lazySingleton<_i1071.AuthRepo>(() => _i868.AuthRepoImpl(gh<_i840.AuthDatasource>()));
...
class _$AppModuleDepedenciesProvider extends _i895.AppModuleDepedenciesProvider {}

class _$AuthRepoteDatasourceProvider extends _i840.AuthRepoteDatasourceProvider {}
