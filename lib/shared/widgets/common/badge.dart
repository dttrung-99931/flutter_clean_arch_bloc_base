...
class AppBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: const BoxDecoration(shape: BoxShape.circle, color: AppColors.redDeep),
      padding: EdgeInsets.all(number <= 9 ? 6.r : 4.r),
      child: Text(number.toString(), style: textTheme.labelLarge.withColor(AppColors.white)),
    );
  }
}
