...
import 'package:maingames_flutter_test/shared/widgets/cutstom_button.dart';
import 'package:flutter/material.dart';

class UnregisterWidget extends StatelessWidget {
  const UnregisterWidget({super.key, required this.title, required this.buttonTitle, required this.onPressed});
  final String title;
